package cpi.scripts.mapping.udf.logical_operations
...
class BooleanToggleTest extends Specification{
    ...
    def setupSpec() {
        ...
        Class scriptClass = classLoader.loadClass("cpi.scripts.mapping.udf.logical_operations.BooleanToggle")
