...
class DateTimeFormatterTest extends Specification{
    ...
    def setupSpec() {
        ...
        Class scriptClass = classLoader.loadClass("cpi.scripts.mapping.udf.datetime_manipulation.DateTimeFormatter")
